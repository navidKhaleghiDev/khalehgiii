...
export const inputRegexPattern = {
	...
	lettersEnglishSpace: {
		value: /^[a-zA-Z-_0-9]*$/i,
		message: 'لطفاً فقط از حروف انگلیسی و اعداد استفاده کنید(کاراکتر های مجاز - و _)',
	},
	enCharAndNumber: {
		value: /^[A-Za-z0-9]*$/,
	...
	gitUrl: {
		...
		message: 'آدرس گیت باید همان آدرسی باشد که برای کلون کردن استفاده میشود و به .git ختم شود.',
	},
	smallLettersThenNumbers: {
		value: /^[a-z][a-z0-9-_ ]*$/gm,
		message: 'نام پوشه حتما باید حروف کوچک انگلیسی باشد و نباید با عدد شروع شود',
	},
	farsiLetters: {
		value: /[ا-ی]/gi,
