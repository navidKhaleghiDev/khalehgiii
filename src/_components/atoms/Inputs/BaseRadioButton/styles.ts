...
export const inputRadioButtonStyles = cva(
  `peer relative cursor-pointer appearance-none rounded-full before:absolute bg-white dark:bg-neutral-500 checked:bg-teal-500 dark:checked:bg-teal-500 border border-neutral-300 checked:border-teal-500 before:content[''] before:w-2 before:h-2 before:block before:bg-white before:rounded before:opacity-0 checked:before:opacity-100 dark:checked:border-teal-500`,
  {
    variants: {
      size: {
