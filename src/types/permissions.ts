...
export enum PermissionKeycloak {
...
export enum PermissionFileScan {
...
export enum PermissionExtensions {
  ADD = 'add_extensions',
  // plus icon , modal add
...
export enum PermissionScanReports {
...
export enum PermissionInternetLogs {
...
export enum PermissionSessionRecording {
...
export enum PermissionDaasMetaConfig {
...
export enum PermissionWhiteListFiles {
...
export enum PermissionMalwareConfig {
...
export enum PermissionGroupManagement {
...
export interface UserPermissionsProps {
  selected: boolean;
  id: number;
  content_type: ContentTypePermission;
  name: string;
